# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            ...
            'integrasi_pos/static/src/xml/pos_ui_custom.xml',
            'integrasi_pos/static/src/xml/category_custom_ui.xml',
            'integrasi_pos/static/src/xml/product_card_custom.xml',
            'integrasi_pos/static/src/xml/void_item_button.xml',
            # 'integrasi_pos/static/src/xml/redeem_point_popup.xml',
            'integrasi_pos/static/src/xml/searching_cashier_login.xml',
            'integrasi_pos/static/src/xml/custom_shortcut_numpad.xml',
            'integrasi_pos/static/src/xml/customer_group.xml',
            'integrasi_pos/static/src/xml/customer_line.xml',
            'integrasi_pos/static/src/xml/pricelist_product_info.xml',
            'integrasi_pos/static/src/xml/product_info_popup.xml',
            ...
            'integrasi_pos/static/src/config/config.json',
            ...
            'integrasi_pos/static/src/js/pos_ui_custom.js',
            'integrasi_pos/static/src/js/urutan_control_button.js',
            'integrasi_pos/static/src/js/void_item_button.js',
            ...
            'integrasi_pos/static/src/js/product_info_popup.js',
            'integrasi_pos/static/src/js/reprint_receipt_invoice.js',
            'integrasi_pos/static/src/js/searching_product_list.js',
            ...
            'integrasi_pos/static/src/css/pos_ui_custom.css',
            'integrasi_pos/static/src/scss/product_card_custom.scss',
            'integrasi_pos/static/src/scss/searching_cashier_login.scss',
            # 'integrasi_pos/static/src/css/redeem_point.css',
