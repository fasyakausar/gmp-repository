...
def main():
    ...
    for instance_name in instancesSS:
        ...
        # integrator_transaksi.transfer_loyalty_point('loyalty.card', ['code', 'points_display', 'expiration_date', 'program_id', 'partner_id', 'source_pos_order_id', 'points'], 'Transfer Discount/Loyalty')
        integrator_transaksi.transfer_manufacture_order('mrp.production', ['id', 'name', 'state', 'is_integrated', 'create_date', 'location_src_id', 'location_dest_id', 'picking_type_id', 'product_id', 'product_qty', 'qty_producing', 'bom_id', 'user_id', 'date_start', 'date_finished', 'move_raw_ids'], 'Transaksi Manufacture Order Inventory', date_from, date_to)
        ...
        # integrator_transaksiMCtoSS.transfer_bom_master('mrp.bom', ['id', 'product_tmpl_id', 'product_id', 'code', 'type', 'product_qty', 'consumption', 'produce_delay', 'days_to_prepare_mo', 'create_date', 'is_integrated', 'bom_line_ids'], 'Master BOM', date_from, date_to)
        ...
        integrator_transaksiMCtoSS.transfer_customer_group('customer.group', ['id', 'vit_group_name', 'vit_pricelist_id'], 'Insert Warehouse')
